      ...
      <section className="mx-auto max-w-5xl px-4 py-10">
        <div className="mb-6">
          ...
          <p className="mt-2 max-w-2xl text-muted-foreground">
            Minimal glass UI to explore your profile, projects and skills from your backend.
          </p>
        </div>
        ...
        <GlassCard className="p-5">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Find projects by keyword or skill.</p>
            </div>
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
          <GlassCard className="p-5">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Browse and filter by skill.</p>
            <Link
              href="/projects"
          ...
          <GlassCard className="p-5">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Your bio, skills, links and work.</p>
            <Link
              href="/profile"
              className="mt-3 inline-block rounded-md bg-primary px-3 py-2 text-sm font-medium text-primary-foreground hover:opacity-90"
            >
          ...
          <GlassCard className="p-5">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Check if the API is alive.</p>
            <Link
              href="/health"
              className="mt-3 inline-block rounded-md bg-primary px-3 py-2 text-sm font-medium text-primary-foreground hover:opacity-90"
            >
